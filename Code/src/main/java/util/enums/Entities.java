...
public enum Entities {
    ...
    Dachbox("src\\main\\resources\\database\\dachbox.csv", new String[]{"Dachbox-ID", "Volumen", "Höhe", "Name", "Beschreibung", "kompatibel", "Fahrzeug-ID"}),
    ...
    Hundetransportbox("src\\main\\resources\\database\\hundetransportbox.csv", new String[]{"Hundetransportbox-ID", "Hundekompatibilität", "AnzahlHunde", "Beschreibung", "Name", "FahrzeugKompatibilität", "Fahrzeug-ID"}),
