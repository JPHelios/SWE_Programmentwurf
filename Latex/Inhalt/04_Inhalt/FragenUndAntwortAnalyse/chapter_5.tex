...
\textcolor{YellowGreen}{Was macht ein Mitglied aus, Eigenschaften hat es?}

\textcolor{NavyBlue}{Ein Mitglied ist ein Kunde, der die Dienstleistung unserer Firma in Anspruch nimmt. 
In diesem Sinne beschreibt ein Mitglied eine reale Person, mit allen Informationen, die zur Abbildung nötig sind. 
...
\textcolor{NavyBlue}{Es sollen alle Datensätze selektiert werden können, die Mitgliederdaten, Termin- und Buchungsdaten, sowie Rechnungsdaten enthalten. Kurz gesagt alle Daten, die auch für eine sinnvolle Erstellung von Backups benötigt werden. }
...
\textcolor{YellowGreen}{Was ist unter Ausrüstung zu verstehen?}

\textcolor{NavyBlue}{Unter Ausrüstung verstehen wir zusätzliches Equipment, welches mit dem Auto gemietet werden kann. Das mieten der Ausrüstung sorgt dabei für keinen Aufpreis. Zur Ausrüstung zählen Dachboxen, Fahrradträger und Hundetransportboxen. Dieses Spektrum wird vorerst nicht erweitert.}
...
\begin{itemize}
    ...
    \textcolor{NavyBlue}{Organisatoren haben vollen Zugriff auf Buchungs- und Fahrzeugdaten, Lesezugriff auf Rechnungsdaten und keinen Zugriff auf etwaige Personaldaten. Außerdem soll es für Organisatoren nicht möglich sein Bilder hochzuladen.}
    ...
    \textcolor{YellowGreen}{Wie sollen die Buchungsdaten gespeichert werden?}
...
\textcolor{NavyBlue}{In der Anwendung sollen nur anwendungsbezogene Personaldaten wie Rechte innerhalb der Anwendung etc. verwaltet werden.}
...
\begin{itemize}
    ...
    \textcolor{NavyBlue}{Dies ist leider nicht möglich, da die zu zahlende Summe erst nach der Fahrt sicher feststeht. Daher wird standardmäßig per Rechnung gezahlt. In Zukunft soll es auch möglich sein per SEPA-Lastschriftmandat zu zahlen.}
    ...
    \textcolor{NavyBlue}{Für Onlinebuchungen oder in der Filiale soll die Möglichkeit existieren per SEPA-Lastschrift automatisch die Kosten einzubeziehen. Dazu muss offiziell ein Mandat vom Mitglied aus erteilt werden.}
...
\begin{tabular}{l | p{13cm}}
    ...
    \textcolor{NavyBlue}{Nein, es soll in allen Fällen eine Auswahl geben. Für die Textgröße soll zwischen klein, normal und groß entschieden werden können. Bezüglich der Fenstergröße soll man die gängigsten Größen, wie auch bei anderen Programmen wählen können.
...
\begin{tabular}{l | p{13cm}}
    ...
    \textcolor{NavyBlue}{
        \begin{itemize}
            \item Administrator: Hat Zugriff auf alle Datenbestände und Funktionen
            \item Organisator: Fahrzeuge (bis auf Bilder), Kunden, Buchungen, Rechnungen
    ...
    \textcolor{YellowGreen}{Welche Daten sollen für Mitarbeiter, Fahrzeuge, Standorte, Kunden, Buchungen, Rechnungen, Änderungen, Stornierungen und Mahnungen erhoben werden?}

    \textcolor{NavyBlue}{
        \begin{itemize}
            \item  Mitarbeiter: Rollen und Kontaktmöglichkeiten
            \item Fahrzeug: Kennzeichen, Typ/Bezeichnung, Kategorie, Farbe, Baujahr, Buchungen 
            \item Standort: Adresse, ansässige Fahrzeuge, maximale Fahrzeugzahl 
            ...
            \item Änderung: Änderungszeitpunkt und Person, welche verantwortlich für Änderung ist
            \item Stornierung: Es ist nur relevant, ob eine Buchung storniert wurde oder nicht
            \item Mahnung: siehe Rechnung
        \end{itemize}       
    } \\
    \hline
\end{tabular}
...
\begin{tabular}{l | p{13cm}}
    ...
    \textcolor{NavyBlue}{Nein das gibt es nicht. Allerdings soll es Rabattaktionen geben, welche sich auf ganze Fahrzeugklassen beziehen, geben.}

    \textcolor{YellowGreen}{Soll es auch Eventwochen und Rabattaktionen geben?}

    \textcolor{NavyBlue}{Ja, es soll zum Beispiel zu besonderen Anlässen Rabattaktionen durchgeführt werden. Solche Ereignisse wären zum Beispiel Firmenjahrestage, besonderere Mitgliederanzahlen und kulturelle Ereignisse.}
    ...
    \textcolor{NavyBlue}{Für unseren Anwendungsfall reicht es aus, wenn nur die letzte Änderung zu sehen ist.}
    \\
    \hline
\end{tabular}
...
\begin{tabular}[ht] {l | p{13cm}}
    ...
    \textcolor{NavyBlue}{Dies ist in Zukunft auf jeden Fall geplant.}
...
\begin{tabular}[ht] {l | p{13cm}}
    ...
    \textcolor{NavyBlue}{Buchungen sollen auch spontan möglich sein. Allerdings können sie dann nicht mehr storniert werden.}
    \\
    \hline
\end{tabular}
...
\begin{tabular}[ht] {l | p{13cm}}
    ...
    \textcolor{NavyBlue}{Die Anzahl der Bilder pro Element soll auf 3 beschränkt sein.}
...
\begin{center}
    \begin{tabular}[ht] {l | p{13cm}}
        ...
        \textcolor{NavyBlue}{Es soll ein mal pro Woche ein komplettes Backup erstellt werden. Zusätzlich können von Administratoren jederzeit Backups erstellt werden.}
...
\textcolor{YellowGreen}{Was macht die Anwendung zuverlässig? Stabilität oder Fehlertoleranz?}
...
\textcolor{YellowGreen}{Die Benutzbarkeit soll sehr gut sein. Welche Anforderungen stehen dahinter? Durch was wird das Programm leicht bedienbar? Mit welchen Hilfsmitteln kann die Bedienbarkeit erleichter werden (Shortcuts, Gesten)?}
...
\textcolor{YellowGreen}{Die Gestaltung soll sehr gut sein? Ist das nötig, wenn in den Büros eigentlich nur die Mitarbeiter arbeiten und die Kunden gar nicht in den Kontakt mit der Anwendung treten?}
...
\textcolor{YellowGreen}{ Die Portabilität ist normal relevant, aber die Plattformunabhängigkeit ist besonders zu beachten? Wie ist das zu verstehen?}
