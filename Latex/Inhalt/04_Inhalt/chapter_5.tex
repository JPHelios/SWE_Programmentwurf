...
\begin{center}
    \begin{tabular}[ht] {l | p{13cm}}
        ...
        \textcolor{YellowGreen}{Soll die Applikation auch mobil genutzt werden -> auch kompatibel für Mobilgeräte?}
...
\textcolor{YellowGreen}{Was bedeuten die einzelnen Begriffe und ihre Bewertung für die zu entwickelnde Applikation?}

\textcolor{YellowGreen}{Gibt es für die Zuverlässigkeite bestimmten Konventionen, Standards oder Vorschriften, die eingehlante nwerden müssen? SLA?}
