...
\begin{itemize}
    ...
    \textcolor{NavyBlue}{Da heutzutage eine Webseite modern und 'cool' aussehen muss, ist es denkbar, dass das Design und die Darstellung in der Webanwendung stark von der Desktopanwendung abweichen kann. Die Darstellung der Karte mit den verfügbaren Fahrzeugen soll jedoch gleich sein.}
...
\begin{tabular}{l | p{13cm}}
    ...
    \textcolor{NavyBlue}{Nein, es soll in allen Fällen eine Auswahl geben. Für die Textgröße soll zwischen klein, normal und groß entschieden werden können, die Schriftart soll nur 'sinnvolle' Schriftarten abdecken, also solche komischen Spielereien wie Symbolsprachen und Co. sollen nicht zugelassen sein und beim Farbmodus gibt es nur die zwei Möglichkeiten}
    ...
    \textcolor{YellowGreen}{Wo und in welcher Form sind die Kundendaten gespeichert? Magnetband, Chip oder QR-Code?}
